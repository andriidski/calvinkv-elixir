defmodule LatencyExperiment.Raft do
  use ExUnit.Case
  ...
  test "run multiple latencies experiment with Raft replication" do
    ...
    Enum.map(0..15, 
      fn val ->
        ...
        configuration = Configuration.new(
          _replication=ReplicationScheme.Raft.new(_num_replicas=5, num_partitions), 
  ...
  test "run single latency experiment with Raft replication" do
    Emulation.init()
